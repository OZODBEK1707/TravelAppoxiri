...
import com.rosh.travelapp.databinding.ActivityFourthBinding
...
class FourthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.thirdArrowUp.setOnClickListener {
            val intent = Intent(this@FourthActivity, FivesActivity::class.java)
            var destination_registon = LatLng(39.65475857332522, 66.97573112512643)
            startActivity(intent)
        }
    }
}