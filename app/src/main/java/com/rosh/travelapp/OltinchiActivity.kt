...
import com.rosh.travelapp.databinding.ActivityOltinchiBinding

class OltinchiActivity : AppCompatActivity() {
    private lateinit var binding: ActivityOltinchiBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOltinchiBinding.inflate(layoutInflater)
        ...
        binding.secondBackArrow.setOnClickListener {
            val intent = Intent(this@OltinchiActivity, MainActivity::class.java)
        ...
        binding.secondArrowUp.setOnClickListener {
            val intent = Intent(this@OltinchiActivity, YettinchiActivity::class.java)
            startActivity(intent)
        }
    }
}